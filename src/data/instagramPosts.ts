...
export const instagramPosts: InstagramPost[] = [
  ...
  {
    id: 4,
    src: '/images/instagram/ig-04.webp',
    caption: 'Notre priorité est la satisfaction du client. Avant/après rénovation complète.',
    tags: ['avantapres', 'renovation', 'marbre', 'bois'],
    instagramUrl: 'https://www.instagram.com/ibocarrelage/',
  },
  {
    id: 5,
    src: '/images/instagram/ig-05.jpg',
    caption: 'Carrelage salle de bain — Chambéry. Devis gratuit. Expérience · Qualité.',
  ...
  {
    id: 7,
    src: '/images/instagram/ig-07.webp',
    caption: 'Pose faïence murale — travaux de qualité. Chambéry, Bassens, Savoie.',
    tags: ['faience', 'bassens', 'salledebain'],
    instagramUrl: 'https://www.instagram.com/ibocarrelage/',
  },
  {
    id: 8,
    src: '/images/instagram/ig-08.jpg',
  ...
  {
    id: 9,
    src: '/images/instagram/ig-09.webp',
  ...
  {
    id: 10,
    src: '/images/instagram/ig-10.webp',
  ...
  {
    id: 11,
    src: '/images/instagram/ig-11.webp',
